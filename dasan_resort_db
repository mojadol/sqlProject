...
(
    ...
    `Service_Type`   INT            NOT NULL    CHECK(Service_Type IN ('슈샤인','수원 전통주 체험', '광교호 둘레길 투어','다도체험','수원 화성 투어','농장 체험','떡 만들기')) COMMENT '서비스 유형', 
    `Service_Price`  INT            NOT NULL    CHECK(Service_Price IN ('3000', '50000','30000','40000','60000')) COMMENT '서비스 가격', 
...
(
    ...
    `Room_Price`    INT           NOT NULL    Check (Room_Price IN('200000','300000','400000','500000','600000','700000')) COMMENT '객실 가격', 
    ...
    `Room_Type`     VarChar(15)   NOT NULL    CHECK (ROOM_Type IN('디럭스룸','비즈니스룸','수페리어룸','디럭스룸 suite','비즈니스룸 suite', '수페리어룸 suite')) COMMENT '객실 타입', 
