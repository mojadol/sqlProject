...
('코로나', '2021-06-15 15:55:23', '8', '100000', '29', '4'),
('코로나', '2021-06-07', '1', '40000', '11', '1', '5');

------테스트------------
INSERT INTO BOOKCANCEL (Can_Reason, Can_CurrentDate, Can_Datedif, Can_Refund, Booking_ID, Pol_ID) (select '코로나', curdate(), booking_checkindate-bookcancel.can_currentdate,
booking_totalamount*(select pol_refundRate from cancelpolicy where Pol_Datedif = 7 and pol_datedif > 7)
, booking.booking_id, cancelpolicy.pol_id from booking, cancelpolicy, bookcancel where cust_id = 29);
-------------------
...
-------테스트
insert into cardkey(room_id, cust_id) (select room_id, customer.cust_id from roomstate, customer where customer.Cust_id = 17);
---------------
select * from cardkey;
